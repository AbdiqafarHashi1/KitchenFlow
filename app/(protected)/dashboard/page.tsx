  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-3 xl:grid-cols-6">
        ...
        <Card title="Active Staff" value={String(activeStaffCount)} />
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <div className="card p-4">
          ...
          <p className="mt-2 text-3xl font-semibold text-accent">
            {formatCurrency(dailyCashResult)}
          </p>
        ...
        <div className="card p-4">
          ...
          {usageReady ? (
            <p className="mt-2 text-3xl font-semibold text-accent">
              {formatCurrency(dailyGrossFromUsage)}
            </p>
          ) : (
      ...
      <div className="grid gap-4 xl:grid-cols-2">
        ...
        <div className="card overflow-hidden">
          <div className="border-b border-border p-4">
            <h3 className="font-medium">Recent Advances</h3>
          </div>
          <div className="overflow-x-auto">
            <table className="min-w-full text-sm">
              <tbody>
        ...
        <div className="card overflow-hidden">
          <div className="border-b border-border p-4">
            <h3 className="font-medium">Recent Inventory Movements</h3>
          </div>
          <div className="overflow-x-auto">
            <table className="min-w-full text-sm">
              <tbody>
